...
function showGames(list) {
  ...
  list.forEach((g) => {
    // loop through all the games in https://cdn.jsdelivr.net/gh/JustJxrdanWasDefinetlyTaken/cassets@main/celestialisbest/assets/json/books.json
...
// main game func
fetch("https://cdn.jsdelivr.net/gh/JustJxrdanWasDefinetlyTaken/cassets@main/celestialisbest/assets/json/books.json")
  .then((res) => res.json())
  .then((games) => {
